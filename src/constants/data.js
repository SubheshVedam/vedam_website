...
export const curriculumData = [
  {
    ...
    outcomes: [
      {
        image: "/img/image.png",
        title: "Building Hotstar like Feed with Search and Categories",
      },
      {
        image: "/img/image (1).png",
        title: "Build a Portfolio Website like GitHub Pages",
      },
      {
        image: "/img/image (2).png",
        title: "Develop an Online Resume Builder like Canva",
      },
    ],
  },
  {
    ...
    description:
      "Dive deeper into full-stack development with hands-on projects.",
    skills: [
      "React",
      "Node.js",
      "Express",
