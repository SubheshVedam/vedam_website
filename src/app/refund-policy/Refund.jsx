      ...
      >
        ...
        <Box>
          ...
          <Typography paragraph>
            This policy outlines the guidelines for refunding seat block fees for students at Vedam
            School of Technology. Students and parents are encouraged to review these terms
          ...
          <Typography paragraph>
            ...
            from their registered email ID. The request must include payment details and the reason
            for the refund.
          </Typography>
          <Typography paragraph>
          ...
          <Typography paragraph>
            Special consideration refund requests will be processed only after verification and must
            be submitted within the deadline. Such requests must be made within 14 days of the
            official Class 12th result announcement date.
          </Typography>
        ...
        <Box>
          ...
          <Typography fontWeight="bold" mb={1}>
            For Students pursuing 12th Class in 2026 and If the student’s final Class 12th score is
            below 50%:
          </Typography>
          <TableContainer component={Paper} variant="outlined">
            <Table size="small">
              ...
              <TableBody>
                <TableRow>
                  <TableCell>
                    Requests made within 14 days of the official Class 12th result announcement date.
                  </TableCell>
                  <TableCell>90% Refund</TableCell>
                </TableRow>
              </TableBody>
