      ...
      >
        ...
        <Box component="section">
          <Typography paragraph>
            ...
            through or in connection with our Services.
          </Typography>
          <Typography paragraph>
            We at SET Education Technology Private Limited (“SET Education
            Technology Private Limited,” the “Company,” “we,” “us,” and “our,”)
            firmly believe in the highest standards of integrity in relation to
            information provided by our customers when they use our services and
            otherwise.
          </Typography>
          <Typography paragraph>
            This policy describes the types of information that we may collect
            from you when you access or use our website or applications or any
            other online services (collectively, our “Services”); and our
        ...
        <Box component="section">
          ...
          <Typography paragraph>We collect this information:</Typography>
          <ul style={{ paddingLeft: "1.25rem", marginBottom: "1rem" }}>
          ...
          <ul style={{ paddingLeft: "1.25rem", marginBottom: "1rem" }}>
            <li>
              Your account information: Full name, email, postal code, password,
              mobile number, etc.
            </li>
            <li>
              Your content: Batting parameters, motion sensor data, and profile
              details.
            </li>
          </ul>
          ...
          <ul style={{ paddingLeft: "1.25rem", marginBottom: "1rem" }}>
            ...
            <li>
              Computer/device info: IP, OS, browser, network details, device
              identifiers.
            </li>
          ...
          <Typography>
            We may anonymize and/or de-identify information for analysis and
            improvements. Such data is not restricted by this policy and may be
        ...
        {[
          ...
          },
          {
            ...
            text: (
              <>
                We use industry-standard measures to protect your data but
          ...
          },
          {
            ...
            text: (
              <>
                If you have queries about how your data is used, contact our
                Grievance Officer:
                <br />
                Email:{" "}
                <MuiLink
