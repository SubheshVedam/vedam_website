...
export const AIYear1 = () => {
  return (
    ...
    >
      ...
      >
        {homeScreenData.year1.secondTitle}
      </Typography>
      <Box
        sx={{
          display: "flex",
      ...
      >
        {homeScreenData.year1.secondArray.map((item, index) => (
          <Box
            key={index}
            sx={{
