...
export const AIYear3 = () => {
  return (
    ...
    >
      ...
      >
        {homeScreenData.year3.secondTitle}
      </Typography>
      <Box
        sx={{
          display: "flex",
      ...
      >
        {homeScreenData.year3.secondArray.map((item, index) => (
          <Box
            key={index}
            sx={{
      ...
      >
        {homeScreenData.year3.outcomeArray.map((item) => (
          <SingleCard
            key={item.id}
            icon={item.icon}
            text={item.text}
