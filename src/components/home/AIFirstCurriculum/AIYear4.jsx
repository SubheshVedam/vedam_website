...
export const AIYear4 = () => {
  return (
    ...
    >
      ...
      >
        {homeScreenData.year4.secondTitle}
      </Typography>
      <Box
        sx={{
          display: "flex",
      ...
      >
        {homeScreenData.year4.secondArray.map((item, index) => (
          <Box
            key={index}
            sx={{
      ...
      >
        {homeScreenData.year4.outcomeArray.map((item) => (
          <SingleCard
            key={item.id}
            icon={item.icon}
            text={item.text}
